...
function Home() {
	...
	return (
		<ThemeProvider theme={theme}>
			<main>
				<script src="https://use.fontawesome.com/releases/v5.12.1/js/all.js" data-auto-replace-svg="nest" />
				<GlobalStyles />
				<section ref={node}>
				...
				<CSSTransition in={true} appear={true} timeout={1500} classNames="fade">
					<h1>
						Hello.<br />
						<br />
						My name is Callum Goodley. <br />
						<br />
						I am a Junior Software Developer.<br />
						<br />
						Welcome to my webpage.
						<p className="emoji" role="img" aria-label="home emoji">
							&#x1f468;&#x1f3fb;&#x200d;&#x1f4bb;
						</p>
					</h1>
				</CSSTransition>
