			...
			<main>
				...
				<CSSTransition in={pageAppear} appear={true} timeout={1500} classNames="fade">
					<section>
						<h1>About me...</h1>
						<p className="about">
							I am a Manchester based software developer who has recently graduated from the Northcoders
							bootcamp. Since embarking on a career change to software development I have been constantly
							fascinated by all things code and enjoy learning more and more.
							<br />
							<br />
							My experience in coding so far has been using Javascript to write front-end React and
							React-Native apps using a pSQL backend as well as going serverless on my final project app
				...
				<footer className="foot">
					<a href="https://github.com/callumgoodley?tab=repositories">
						<svg
							aria-hidden="true"
							focusable="false"
							data-prefix="fab"
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="https://www.linkedin.com/in/callum-goodley-070682136/">
						<svg
							aria-hidden="true"
							focusable="false"
							data-prefix="fab"
							data-icon="linkedin"
							class="svg-inline--fa fa-linkedin fa-w-18 fa-2x"
							role="img"
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 448 512"
						>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="https://twitter.com/callumgoodley">
						<svg
							aria-hidden="true"
							focusable="false"
							data-prefix="fab"
					...
					&nbsp;&nbsp;&nbsp;&nbsp;
					<a href="https://www.facebook.com/callum.goodley">
						<svg
							aria-hidden="true"
							focusable="false"
							data-prefix="fab"
